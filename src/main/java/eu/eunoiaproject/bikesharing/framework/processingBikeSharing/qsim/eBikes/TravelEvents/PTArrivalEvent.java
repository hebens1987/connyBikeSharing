 ...
 */
public final class PTArrivalEvent extends Event implements HasPersonId {

	public static final String ATTRIBUTE_PERSON = "person";
	public static final String ATTRIBUT_DISTANCE = "distance";
	public static final String EVENT_TYPE = "travelled_pt";


    private Id<Person> agentId;
    private double distance;

    public PTArrivalEvent(double time, Id<Person> agentId, double distance) {
        super(time);
