 ...
 */
public final class BsArrivalEvent extends Event implements HasPersonId {

	public static final String ATTRIBUTE_PERSON = "person";
	public static final String ATTRIBUT_DISTANCE = "distance";
	public static final String EVENT_TYPE = "travelled_bs";


    private Id<Person> agentId;
    private double distance;

    public BsArrivalEvent(double time, Id<Person> agentId, double distance) {
        super(time);
