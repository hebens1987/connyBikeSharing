...
{
	public BikeSharingFacility stationE;
	public BikeSharingFacility nearestStationE;
	public double probabilityE;
	public BikeSharingFacility stationC;
	public BikeSharingFacility nearestStationC;
