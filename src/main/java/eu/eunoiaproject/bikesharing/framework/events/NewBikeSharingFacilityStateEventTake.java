...
public class NewBikeSharingFacilityStateEventTake extends Event {
	public static final String EVENT_TYPE = EBConstants.INTERACTION_TYPE_BS + "_t";

	private final Id<BikeSharingFacility> facilityId;
	private final int newAmountOfBikes;
	private final int newAmountOfParkings;

	public NewBikeSharingFacilityStateEventTake(
			final Event event) {
		super( event.getTime() );
