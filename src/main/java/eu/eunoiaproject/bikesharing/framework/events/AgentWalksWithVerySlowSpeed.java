...
public class AgentWalksWithVerySlowSpeed extends AbstractPersonEvent {
	public static final String EVENT_TYPE = "agentWalksBackHomeWithVeryLowSpeed";

	public AgentWalksWithVerySlowSpeed(
			final Event event) {
		super( event );
