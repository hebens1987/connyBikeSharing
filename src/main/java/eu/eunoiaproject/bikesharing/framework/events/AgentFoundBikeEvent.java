 ...
 * @author thibautd
 */
public class AgentFoundBikeEvent extends AgentStopsWaitingForBikeEvent{
	public static final String EVENT_TYPE = "agent stops Waiting as he found a bike";

	/***************************************************************************/
	public AgentFoundBikeEvent(
			final Event event) 
	/***************************************************************************/
	{
		super( event );
