 ...
 * @author thibautd
 */
public class TUG_BsWalkRoutingModule implements RoutingModule {
	...
	private static final Logger log = Logger.getLogger(TUG_BsWalkRoutingModule.class);
	
	/***************************************************************************/
	public TUG_BsWalkRoutingModule() 
	/***************************************************************************/
	{
	}
	/***************************************************************************/
	public TUG_BsWalkRoutingModule(Scenario scenario) 
	/***************************************************************************/
	{
	...
	/***************************************************************************/
	{
			...
			RoutingModuleHelper rmh = new RoutingModuleHelper(fromFacility, toFacility, 
					...
					scenario, btt, EBConstants.BS_WALK);
			return rmh.peList;
	}
