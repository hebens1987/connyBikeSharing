...
//		assert minY <= maxY : minY +" > "+maxY;
		// the Java assert statement is by default honoured in test cases only, which is why then these fail when the quad tree is empty.  However, everything else is happy
		// about an empty quad tree.  kai, apr'19
