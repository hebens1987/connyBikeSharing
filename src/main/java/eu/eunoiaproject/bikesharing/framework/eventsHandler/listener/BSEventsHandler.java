...
public class BSEventsHandler implements PersonLeavesVehicleEventHandler, PersonEntersVehicleEventHandler, PersonArrivalEventHandler, PersonDepartureEventHandler, LinkLeaveEventHandler{
	...
	public BSEventsHandler(Network network) {
	...
	public void handleEvent(PersonEntersVehicleEvent event) {
		// TODO Auto-generated method stub
		if (event.getVehicleId().toString().startsWith("BS"))
	...
	public void handleEvent(PersonDepartureEvent event) {
		...
		if (event.getLegMode().equals(EBConstants.BS_WALK)) {
		...
		else if (event.getLegMode().equals(EBConstants.MODE)) {
	...
	public void handleEvent(PersonArrivalEvent event) {
		...
		if (event.getLegMode().equals(EBConstants.MODE)) {
			RentalInfoOW info = owRentalsStats.get(event.getPersonId());
			info.endTime = event.getTime();
			info.endLinkId = event.getLinkId();
			
		}
		else if (event.getLegMode().equals(EBConstants.BS_WALK)) {
