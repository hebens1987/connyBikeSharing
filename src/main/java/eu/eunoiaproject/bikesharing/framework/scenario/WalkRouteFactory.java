 ...
 * @author thibautd
 */
public class WalkRouteFactory implements RouteFactory {
	private static final Logger log =
		Logger.getLogger(WalkRouteFactory.class);
	...
	public Route createRoute(
		...
		if ( log.isTraceEnabled() ) log.trace( "creating walk route between links "+startLinkId+" and "+endLinkId );
