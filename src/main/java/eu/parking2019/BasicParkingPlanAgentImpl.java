...
public class BasicParkingPlanAgentImpl implements MobsimAgent, PlanAgent, Identifiable<Person>, HasPerson, VehicleUsingAgent {
	...
	public BasicParkingPlanAgentImpl(Plan plan2, Scenario scenario, EventsManager events, MobsimTimer simTimer) {
...
//			this.setCurrentLinkId( firstAct.getLinkId() ) ;
	...
	public final void setActivityEndTime(double activityEndTime) 
	/***************************************************************************/
	{
		this.activityEndTime = activityEndTime; //Hebenstreit
	}
	...
	//new: Hebenstreit
		/***************************************************************************/
		public final void setPlanElement( int index, PlanElement pe) 
		/***************************************************************************/
		{
			this.plan.getPlanElements().set(index, pe);
		}
		
		/***************************************************************************/
		public final void setAllPlanElement( List<PlanElement> pe) 
		/***************************************************************************/
		{
			int size0 = this.plan.getPerson().getSelectedPlan().getPlanElements().size();
			this.plan.getPerson().getSelectedPlan().getPlanElements().clear();
			int size1 = this.plan.getPerson().getSelectedPlan().getPlanElements().size();
			this.plan.getPerson().getSelectedPlan().getPlanElements().addAll(pe);
			int size2 = this.plan.getPerson().getSelectedPlan().getPlanElements().size();
		}
    ...
    /***************************************************************************/
	public final void setCurrentPlanElementIndex(int index) //Hebenstreit
	/***************************************************************************/
    {
		this.currentPlanElementIndex = index;
	}
	...
	/* default */ public final int getCurrentPlanElementIndex() {
