...
public class PlanBasedParkingDriverAgentImpl implements DriverAgent {

	private static final Logger log = Logger.getLogger(PlanBasedDriverAgentImpl.class);

	private BasicParkingPlanAgentImpl basicPlanAgentDelegate;

	public PlanBasedParkingDriverAgentImpl(BasicParkingPlanAgentImpl basicAgent ) {
